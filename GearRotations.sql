...
declare @axisDistance float = @ellipseR + @midCylinderR; -- межцентровое расстояние 2,79321755816625 -> @axisDistance * @unit = 59,9983131494111
-- Межосевое расстояние принято за 60.0
